  ...
  return SimpleDialog(
    children: [
      new Column(
        ...
        children: [
          Padding(
            padding: new EdgeInsets.symmetric(vertical: 15.0, horizontal: 40.0),
            child: new Text(
...
Widget makeGridCell() {
  ...
  return new GestureDetector(
    onTap: () => showDialog(
          builder: (BuildContext context) => _dialogbuilder(context, _data[index]),
        ),
  child: new Card(
    elevation: 7.0,
    child: Column(
